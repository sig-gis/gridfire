...
our database given the database name and schema as inputs.
...
To run the script, give it our database name and schema.
...
To run the script, give it the database name, schema and srid we wish the layers to have.
...
Other optional output mappings:
